...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_SCOPE_MODEL_ORIGIN: z.string().optional(),
  },
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_SCOPE_MODEL_ORIGIN:
      process.env.NEXT_PUBLIC_SCOPE_MODEL_ORIGIN ?? process.env.SCOPE_MODEL_ORIGIN,
  },
